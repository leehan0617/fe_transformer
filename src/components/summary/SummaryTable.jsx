                                    ...
                                    {DIST_COLS.map((c) => {
                                        ...
                                        return (
                                            <td
                                                ...
                                                onClick={isClickable && numValue > 0 ? () => {
                                                    console.log('[SummaryTable] 클릭된 row:', { branch: r.branch, departmentCode: r.departmentCode, distKey: c.key });
                                                    onOpenDetailModal({ branch: r.branch, departmentCode: r.departmentCode, distKey: c.key });
                                                } : undefined}
